...
describe Api::V1::BatchesController, type: :request do
  ...
  describe "GET #show" do
    ...
    it "should return a serialized batch" do
      ...
      expect(first_consumable[:uri]).to eql("http://www.example.com/api/v1/consumables/#{batch.consumables.first.id}")
    end
    ...
    it 'should return the batch\'s ingredients' do
      ...
      expect(first_ingredient[:uri]).to eql("http://www.example.com/api/v1/ingredients/#{batch.ingredients.first.id}")
    end
