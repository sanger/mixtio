...
RSpec.describe AuthenticationForm, type: :model do |variable|
  ...
  it "should not create the record if the user does not exist" do
    ...
    expect(model_c_form.errors.full_messages).to include("User #{I18n.t("errors.existence")}")
  end
  ...
  it "should not create the record if the user is not authorised" do
    ...
    expect(model_c_form.errors.full_messages).to include("User #{I18n.t("errors.authorised")}")
  end
  ...
  it "should not create the record if the user is inactive" do
    ...
    expect(model_c_form.errors.full_messages).to include("User #{I18n.t("errors.active")}")
  end
end