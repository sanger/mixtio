...
module Batches
  class Index
    ...
    def initialize(params)
      ...
      @created_after      = params.fetch(:created_after, nil)
      @created_before     = params.fetch(:created_before, nil)
    ...
    def batches
      ...
      batches = batches.where("created_at > ?", created_after.to_date) unless created_after.blank?
      batches = batches.where("created_at < ?", created_before.to_date) unless created_before.blank?
